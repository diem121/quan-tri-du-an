...
public class BookAdapter extends BaseAdapter {
    ...
    public class ViewAnhXa{
        TextView tensach, tacgia, theloai, soluong,giasach;
        ImageView imgsach;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            viewAnhXa.giasach = (TextView) convertView.findViewById(R.id.gia_sach);
        ...
        viewAnhXa.giasach.setText( "Giá:"+ decimalFormat.format(book.getGia()));
