...
public class SQLBook extends SQLiteOpenHelper {
    ...
    private static final String Gia_Book = "gia";
    ...
    public void AddBook(Book book) {
        ...
        values.put(Gia_Book,book.getGia());
    ...
    public Book getBook(int bookid){
        db = this.getWritableDatabase();
        Cursor cursor = db.query(Table_Name3, new String[]{BookID_Book, BookTitle_Book, TheLoai_Book, TacGia_Book, NamXB_Book, ImgBook_Book, SoLuong_Book,Gia_Book},
    ...
    public ArrayList<Book> getAllBook(){
        ...
        if(cursor.moveToFirst()){
            do{
                list.add(new Book(cursor.getInt(0),cursor.getString(1),cursor.getString(2),cursor.getString(3),cursor.getString(4), cursor.getInt(5),cursor.getInt(6) ,cursor.getInt(7)));
